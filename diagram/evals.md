...
## Render Pipeline
render_tool: kroki
render_format_detect: "extract first code block, use language tag as format (mermaid, d2, plantuml)"
render_output: PNG
...
### E2: Format matches use case [source]
...
### E3: Every arrow has a text label [source]
...
### E4: Node count under 20 per diagram [source]
...
### E5: Subgraphs used for logical grouping [source]
...
### E6: Color semantics are consistent [both]
...
### E8: Audience-appropriate depth [both]
...
### E9: Accessibility — contrast and labeling [visual]
...
### E10: Data flow direction is consistent [visual]
