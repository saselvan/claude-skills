...
| **Types** | 9 types: follow-up, deliverable, research, intro, nudge, schedule, decline, insight, reactive | 10 meeting-type recaps: discovery, demo, arch review, POC scope, POC checkpoint, EBC, QBR, kickoff, security, working session |
